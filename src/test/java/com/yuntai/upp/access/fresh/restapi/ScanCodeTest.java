 ...
 */
public class ScanCodeTest extends AbstractRestapi<ScanCodeDto, Outcome<ScanCodeVo>> {

    /**
     * 接口路径
     */
    private static final String URL = "/access/scanCode";
        ...
        Arrays.stream(ScanCodeDto.class.getDeclaredFields())
                .forEach(field -> Arrays.stream(field.getDeclaredAnnotations())
                        ...
                        .forEach(annotation -> {
                            ...
                            Outcome<ScanCodeVo> outcome = send(URL, model, new TypeReference<Outcome<ScanCodeVo>>() {});
    ...
    private void execute(@NotNull ScanCodeDto dto) {
        Outcome<ScanCodeVo> outcome = send(URL, dto, new TypeReference<Outcome<ScanCodeVo>>() {});
        Assert.assertNotNull(outcome);
